...
if ($_SESSION['role'] !== 'Nutriologo') {
    ...
    header("Location: login.html?status=error&msg=" . urlencode("Acceso denegado. Este área es solo para nutriologos."));
    exit();
}
...
$html_content = file_get_contents('nutriologo.html');
